...
Use the cout command to output the value of Number to the console.
*/
...
int main() {
  int Number = __ ;     //Update the blanks with the value assigned to Number
  cout << ______ ;      //Output the variable to the console
  return 0;
}
